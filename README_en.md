...
```bash
cd backend && python -m pytest -q          # unit tests (286 passed; AMap-dependent hotel cases skip without AMAP_KEY)
...
- **Tests and CI**: **286 unit tests** all passing (alignment / solving / checking / editor / task pipeline / robustness / preferences / media keys / city-mismatch guards / weather / hotel endpoints), GitHub Actions green
